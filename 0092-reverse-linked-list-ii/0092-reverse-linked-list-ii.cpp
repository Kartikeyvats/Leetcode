...
public:
    ListNode* reverse(ListNode* temp1)
   {
    ...
    return head;       // THAT POINTER WHICH WE HAVE RECEIVED FROM REVERSE FUNCTION. IF PREV!=NULL (LEFT!=1) THIS REFERS THAT
    }                 // HEAD POINTER IS NOT PARTICIPATING IN REVERSING THE LIST THAT WHY HEAD IS NOT DISTURBED AND WE RETURNED HEAD.
};